...
export class WeatherComponent implements OnInit {
  ...
  getByCityName(city) {
    this.api
      .sendGETRequestByCityName(city, this.urlData, this.formatTemp)
      .subscribe((data: any) => {
        this.weather = data;
      });
  ...
  getByCityName5Days(city) {
    ...
    this.api
      .sendGETRequest16Days(city, this.url16Days, this.tempFormatWeekly)
      .subscribe((data: any) => {
  ...
  changeFormat(format) {
    ...
    this.api
      .sendGETRequestByCityName(this.currentCity, this.urlData, this.formatTemp)
      .subscribe((data: any) => {
        this.weather = data;
      });
